            ...
            modelBuilder.Entity("TREK_Web_Diploma.Models.spares.sparesEquipment.Handlebar", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("HandlebarId"));

                    b.Property<string>("HandlebarName")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
